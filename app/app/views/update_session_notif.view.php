...
<div class="panel-header panel-header-sm"  style="height: 70px;padding:0">
            ...
            <div class="content mt-2">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="alert-message alert-message-success">
                                ...
                                <p>Your coaching session has been update successfully.</p>
                                  <p>Coaching ID: <?= $_GET['coachingID'] ?></p>
                                  <p>Name: <?= $_GET['name'] ?></p>
                                  <p>Coaching Date: <?= $_GET['coachingDate']?></p>
                            </div>
                          </div>
                        </div>
                        <?php else: ?>
                        ...
                        <?php if(isset($_GET['success']) && $_GET['success'] =='1'): ?>
                        <?php if($_GET['status_coachee']=='True'): ?>
