          ...
          var received = JSON.parse(JSON.stringify(data)); 
           $('#records').DataTable( {
                                            ...
                                            columns: [
                                                ...
                                                { title: 'ID',data: 'ID' },
                                                { title: 'Name',data: 'SubCategory' },
                                                {data: null, render: function(item){return '<button data-id = "'+item.ID+'" data-name="'+item.SubCategory+'" id = "viewBtn" data-toggle="modal" data-target="#modalID" type="button" rel="tooltip" class="btn btn-info btn-sm btn-round btn-icon"><i class="now-ui-icons users_single-02"></i></button>'}},
                                                {data: null, render: function(item){return '<button data-id = "'+item.ID+'" data-name="'+item.SubCategory+'" data-toggle="modal" data-target="#modalID" id = "updateBtn" type="button" rel="tooltip" class="btn btn-success btn-sm btn-round btn-icon"><i class="fa fa-edit"></i></button>'}},
                                                {data: null, render: function(item){return '<button value="'+item.ID+'" data-name="'+item.SubCategory+'" id = "deleteBtn" type="button" rel="tooltip" class="btn btn-danger btn-sm  btn-round btn-icon"><i class="now-ui-icons ui-1_simple-remove"></i></button>'}},
